  ...
  return (
    <div className="min-h-screen bg-darkBg text-white selection:bg-accent/30">
      <header className="fixed top-0 left-0 w-full h-16 bg-cardBg/80 backdrop-blur-xl border-b border-white/5 flex items-center justify-between px-5 z-40 md:hidden">
        <button onClick={() => setIsOpen(true)} className="text-accent p-2 bg-white/5 rounded-lg transition-transform active:scale-90"><Menu /></button>
        <span className="font-rajdhani font-bold italic text-xl uppercase tracking-tighter">ELITE<span className="text-accent">TRACKER</span></span>
